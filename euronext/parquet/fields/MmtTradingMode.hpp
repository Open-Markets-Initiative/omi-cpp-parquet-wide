...
// field: Mmt Trading Mode
struct MmtTradingMode {

    static constexpr auto name = "mmt_trading_mode";
    static constexpr auto nullable = true;

    MmtTradingMode() = default;
