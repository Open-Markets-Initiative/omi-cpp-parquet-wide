...
// field: Best Bid Denominator Code
struct BestBidDenominatorCode {

    static constexpr auto name = "best_bid_denominator_code";
    static constexpr auto nullable = true;

    BestBidDenominatorCode() = default;
    ...
    // reset best_bid_denominator_code field
    void reset() {
        data.reset();
    }
    ...
    // append best_bid_denominator_code
    ...
    // best_bid_denominator_code schema field
    static auto column() {
