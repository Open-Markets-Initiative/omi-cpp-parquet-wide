...
// field: Long Equity And Index Quote Message Type
struct LongEquityAndIndexQuoteMessageType {

    static constexpr auto name = "long_equity_and_index_quote_message_type";
    static constexpr auto nullable = true;

    LongEquityAndIndexQuoteMessageType() = default;
    ...
    // set long_equity_and_index_quote_message_type
    ...
    // reset long_equity_and_index_quote_message_type field
    void reset() {
        data.reset();
    }
    ...
    // append long_equity_and_index_quote_message_type
    ...
    // long_equity_and_index_quote_message_type schema field
    static auto column() {
