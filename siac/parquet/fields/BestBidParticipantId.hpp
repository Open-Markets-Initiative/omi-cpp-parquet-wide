...
// field: Best Bid Participant Id
struct BestBidParticipantId {

    static constexpr auto name = "best_bid_participant_id";
    static constexpr auto nullable = true;

    BestBidParticipantId() = default;
    ...
    // reset best_bid_participant_id field
    void reset() {
        data.reset();
    }
    ...
    // append best_bid_participant_id
    ...
    // best_bid_participant_id schema field
    static auto column() {
