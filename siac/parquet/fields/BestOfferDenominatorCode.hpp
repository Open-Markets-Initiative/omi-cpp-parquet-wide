...
// field: Best Offer Denominator Code
struct BestOfferDenominatorCode {

    static constexpr auto name = "best_offer_denominator_code";
    static constexpr auto nullable = true;

    BestOfferDenominatorCode() = default;
    ...
    // set best_offer_denominator_code
    ...
    // reset best_offer_denominator_code field
    void reset() {
        data.reset();
    }
    ...
    // append best_offer_denominator_code
    ...
    // best_offer_denominator_code schema field
    static auto column() {
