...
// field: Min Price Increment Optional
struct MinPriceIncrementOptional {

    static constexpr auto name = "min_price_increment_optional";
    static constexpr auto nullable = true;
    static constexpr auto precision = 18;
    static constexpr auto scale = 7;
    static constexpr auto scalar = 10000000;

    MinPriceIncrementOptional() = default;

    // min_price_increment_optional schema field
    void reset() {
        data.reset();
    }
    ...
    // append min_price_increment_optional
