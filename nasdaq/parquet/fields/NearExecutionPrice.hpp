...
// field: Near Execution Price
struct NearExecutionPrice {

    static constexpr auto name = "near_execution_price";
    static constexpr auto nullable = true;
    static constexpr auto precision = 10;
    static constexpr auto scale = 4;
    static constexpr auto scalar = 10000;

    NearExecutionPrice() = default;

    // near_execution_price schema field
    void reset() {
        data.reset();
    }
