...
// field: Auction Collar Reference Price
struct AuctionCollarReferencePrice {
    ...
    AuctionCollarReferencePrice() = default;

    // auction_collar_reference_price schema field
    void reset() {
        data.reset();
    }
    ...
    // append auction_collar_reference_price
