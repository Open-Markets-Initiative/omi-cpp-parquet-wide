...
// field: Minimum Allowable Price
struct MinimumAllowablePrice {

    static constexpr auto name = "minimum_allowable_price";
    static constexpr auto nullable = true;
    static constexpr auto precision = 10;
    static constexpr auto scale = 4;
    static constexpr auto scalar = 10000;

    MinimumAllowablePrice() = default;

    // minimum_allowable_price schema field
    void reset() {
        data.reset();
    }
    ...
    // append minimum_allowable_price
