...
// field: Collar Reference Price
struct CollarReferencePrice {

    static constexpr auto name = "collar_reference_price";
    static constexpr auto nullable = true;
    static constexpr auto precision = 18;
    static constexpr auto scale = 4;
    static constexpr auto scalar = 10000;

    CollarReferencePrice() = default;

    // collar_reference_price schema field
    void reset() {
        data.reset();
    }
