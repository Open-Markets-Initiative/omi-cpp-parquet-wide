...
// field: Indicative Clearing Price
struct IndicativeClearingPrice {

    static constexpr auto name = "indicative_clearing_price";
    static constexpr auto nullable = true;
    static constexpr auto precision = 18;
    static constexpr auto scale = 4;
    static constexpr auto scalar = 10000;

    IndicativeClearingPrice() = default;

    // indicative_clearing_price schema field
    void reset() {
        data.reset();
    }
    ...
    // append indicative_clearing_price
