...
// field: Lower Auction Collar
struct LowerAuctionCollar {

    static constexpr auto name = "lower_auction_collar";
    static constexpr auto nullable = true;
    static constexpr auto precision = 18;
    static constexpr auto scale = 4;
    static constexpr auto scalar = 10000;

    LowerAuctionCollar() = default;

    // lower_auction_collar schema field
    void reset() {
        data.reset();
    }
